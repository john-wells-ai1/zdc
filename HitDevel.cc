...
//  G4VUserPhysicsList* physics = new 
...
//   MyQPSPWLS->RegisterPhysics(new MyAdditionalPhysics("WLS") );

// runManager-> SetUserInitialization(MyQGSP);

// QGSP_BIC_HP * MyQGSP = new QGSP_BIC_HP;
//   MyQGSP->RegisterPhysics(new MyAdditionalPhysics("Cerenkov") );
   runManager->SetUserInitialization(MyQGSP);


//   runManager->SetUserInitialization(MyQPSPWLS); 
//   G4PhysListFactory *physListFactory2 = new G4PhysListFactory();
//   G4VUserPhysicsList *physicsList2 = //physListFactory2->GetReferencePhysList("QGSP_BERT_EMV");
...
//-----------------------------
  ...
  //
  ExN02EventAction* event_action = new ExN02EventAction(run_action, detector, histo);

...
const ExN02EmCalorimeterHit& ExN02EmCalorimeterHit::operator=(
    const ExN02EmCalorimeterHit& right) {
  cellID = right.cellID;
  edep = right.edep;
  pos = right.pos;
  rot = right.rot;
...
int ExN02EmCalorimeterHit::operator==(
    const ExN02EmCalorimeterHit& right) const {

...
void HistoManager::Book(G4double Ekin) {
  ...
  for (G4int ihist = 0; ihist < nhist; ihist++) {
    ...
    sprintf(title1,
            "#splitline{Energy Distribution of Individual Hits in RPD%d:}{2.55 "
            "TeV Neutrons, n=10 Events,Position=[3.0,3.0,-6.0cm]}",
            ihist + 1);
  ...
  for (G4int ihist = 0; ihist < nhist; ihist++) {
    ...
    sprintf(title1,
            "#splitline{Energy Distribution of Individual Hits in PMT%d:}{2.55 "
            "TeV Neutrons, n=10 Events,Position=[3.0,3.0,-6.0cm]}",
            ihist + 1);
  ...
  // N Hit Histogram
  nHit = new TH2I("PMT_nHit",
                  "#splitline{Hits Depositing Energy: 2.55 TeV Neutrons,}{ "
                  "n=10 Events, Position=[3.0,3.0,-6.0 cm]}",
                  4, 0, 4, 4, 0, 4);
  ...
  PMTChannelEnergy =
      new TH2D("PMT_TotalChannelEnergy",
               "#splitline{Total Energy Deposited, MeV: 2.55 TeV "
               "Neutrons,}{n=10 Events, Position=[3.0,3.0,-6.0 cm]}",
               4, 0, 4, 4, 0, 4);
  ...
  ChannelEnergy =
      new TH2D("RPD_TotalChannelEnergy",
               "#splitline{Total Energy Deposited, MeV: 2.55 TeV "
               "Neutrons,}{n=10 Events, Position=[3.0,3.0,-6.0 cm]}",
               4, 0, 4, 4, 0, 4);
  ...
  PosRes = new TH2D("PositionResolution",
                    "#splitline{Geant4 Shower Profile: 2.55 TeV "
                    "Neutrons,}{n=10 Events, Position=[3.0,3.0,-6.0 cm]}",
                    1000, -4.25 * cm, 4.25 * cm, 1000, -4.25 * cm, 4.25 * cm);
  ...
  ThreeDHit = new TH3D("IncidentHitPositions", "3DHits", 100, 5 * cm, 8 * cm,
                       100, -6 * cm, 6 * cm, 100, -10 * cm, 10 * cm);
  ...
  // Incident Gammas
  GammaSpectra =
      new TH1D("GammaSpectrum", "Energies of Gammas Incident on the RPD", 1000,
               0.0 * MeV, 3000 * MeV);
  ...
  GammaSmallSpectra =
      new TH1D("GammaSmallSpectrum", "Energies of Gammas Incident on the RPD",
               100, 0.0 * MeV, 20 * MeV);
  ...
  ESpectra = new TH1D("EPlusEMinusSpectrum",
                      "Energies of e^{+} or e^{-} Incident on the RPD", 1000,
                      0.0 * MeV, 1000 * MeV);
  ...
  // Incident Pions
  PionSpectra = new TH1D("PionSpectrum",
                         "Energies of #pi^{+} or #pi^{-} Incident on the RPD",
                         1000, 100.0 * MeV, 5000 * MeV);
  ...
  NeutronSpectra = new TH1D("NeutronSpectrum",
                            "Energies of n or #bar{n} Incident on the RPD",
                            1000, 0.0 * MeV, 5000 * MeV);
  ...
  ProtonSpectra =
      new TH1D("ProtonSpectrum", "Energies of p or #bar{p} Incident on the RPD",
               1000, 0.0 * MeV, 5000 * MeV);
  ...
  SpeciesDistribution =
      new TH1D("Species Distribution",
               "#splitline{Normalized Distribution of Particle Species: 2.55 "
               "TeV Neutrons,}{n=10 Events, Position=[3.0,3.0,-6.0 cm]}",
               6, 0, 6);
  ...
  ElectronHitEnergy =
      new TH1D("ElectronHitEnergies",
               "Individual Hit Energies of e^{+} or e^{-} in the RPD", 1000,
               0.0 * MeV, 10.0 * MeV);
...
// Top Row of the RPD
void HistoManager::FillEnergyRPD1(G4double Erpd1, G4double Erpd2,
                                  G4double Erpd3, G4double Erpd4) {
...
////////////////////////////////////////////////////////////
// Second Row of RPD
void HistoManager::FillEnergyRPD2(G4double Erpd1, G4double Erpd2,
                                  G4double Erpd3, G4double Erpd4) {
...
//////////////////////////////////////////////////////////////
// Third Row of RPD
void HistoManager::FillEnergyRPD3(G4double Erpd1, G4double Erpd2,
                                  G4double Erpd3, G4double Erpd4) {
...
///////////////////////////////////////////////////////////
// Fourth Row of RPD
void HistoManager::FillEnergyRPD4(G4double Erpd1, G4double Erpd2,
                                  G4double Erpd3, G4double Erpd4) {
...
// Top Row of the PMT
void HistoManager::FillEnergyPMT1(G4double Epmt1, G4double Epmt2,
                                  G4double Epmt3, G4double Epmt4) {
...
////////////////////////////////////////////////////////////
// Second Row of PMT
void HistoManager::FillEnergyPMT2(G4double Epmt1, G4double Epmt2,
                                  G4double Epmt3, G4double Epmt4) {
...
//////////////////////////////////////////////////////////////
// Third Row of PMT
void HistoManager::FillEnergyPMT3(G4double Epmt1, G4double Epmt2,
                                  G4double Epmt3, G4double Epmt4) {
...
///////////////////////////////////////////////////////////
// Fourth Row of PMT
void HistoManager::FillEnergyPMT4(G4double Epmt1, G4double Epmt2,
                                  G4double Epmt3, G4double Epmt4) {
...
void HistoManager::FillNHitsPMT(G4int pmt1, G4int pmt2, G4int pmt3, G4int pmt4,
                                G4int pmt5, G4int pmt6, G4int pmt7, G4int pmt8,
                                G4int pmt9, G4int pmt10, G4int pmt11,
                                G4int pmt12, G4int pmt13, G4int pmt14,
                                G4int pmt15, G4int pmt16) {
  nHit->SetBinContent(
      1, 4, pmt1);  /////////////////////START FIRST ROW///////////////////////
  nHit->SetBinContent(2, 4, pmt2);
  nHit->SetBinContent(3, 4, pmt3);
  nHit->SetBinContent(
      4, 4, pmt4);  //////////////////////END FIRST ROW////////////////////////

  nHit->SetBinContent(
      1, 3, pmt5);  /////////////////////START SECOND ROW///////////////////
  nHit->SetBinContent(2, 3, pmt6);
  nHit->SetBinContent(3, 3, pmt7);
  nHit->SetBinContent(
      4, 3, pmt8);  ////////////////////END SECOND ROW/////////////////////

  nHit->SetBinContent(
      1, 2, pmt9);  ///////////////////START THIRD ROW////////////////////
  nHit->SetBinContent(2, 2, pmt10);
  nHit->SetBinContent(3, 2, pmt11);
  nHit->SetBinContent(
      4, 2, pmt12);  //////////////////END THIRD ROW//////////////////////

  nHit->SetBinContent(
      1, 1, pmt13);  /////////////////START FOURTH ROW///////////////////
  nHit->SetBinContent(2, 1, pmt14);
  nHit->SetBinContent(3, 1, pmt15);
  nHit->SetBinContent(
      4, 1, pmt16);  ////////////////END FOURTH ROW/////////////////////////
}

void HistoManager::FillPositionResolutionTruth(G4double X, G4double Y,
                                               G4double Z, G4double hitenergy,
                                               G4String particleid) {
  ...
  if (particleid == "opticalphoton") {
    ...
    SpeciesDistribution->Fill(5.5, 1);
}

void HistoManager::FillChannelEnergy(
    G4double erpd1, G4double erpd2, G4double erpd3, G4double erpd4,
    G4double erpd5, G4double erpd6, G4double erpd7, G4double erpd8,
    G4double erpd9, G4double erpd10, G4double erpd11, G4double erpd12,
    G4double erpd13, G4double erpd14, G4double erpd15, G4double erpd16) {
  // First Row (Top)
...
void HistoManager::FillPMTChannelEnergy(G4int ipmt) {
  ...
  switch (ipmt) {
    case 0: {
      PMTChannelEnergy->Fill(0.5, 3.5, 1);
      break;
    }  //  1
    case 1: {
      PMTChannelEnergy->Fill(1.5, 3.5, 1);
      break;
    }  //  2
    case 2: {
      PMTChannelEnergy->Fill(2.5, 3.5, 1);
      break;
    }  //  3
    case 3: {
      PMTChannelEnergy->Fill(3.5, 3.5, 1);
      break;
    }  //  4

      // Second Row (Second From Top)
    case 4: {
      PMTChannelEnergy->Fill(0.5, 2.5, 1);
      break;
    }  //  5
    case 5: {
      PMTChannelEnergy->Fill(1.5, 2.5, 1);
      break;
    }  //  6
    case 6: {
      PMTChannelEnergy->Fill(2.5, 2.5, 1);
      break;
    }  //  7
    case 7: {
      PMTChannelEnergy->Fill(3.5, 2.5, 1);
      break;
    }  //  8

      // Third Row (Third From Top)
    case 8: {
      PMTChannelEnergy->Fill(0.5, 1.5, 1);
      break;
    }  //  9
    case 9: {
      PMTChannelEnergy->Fill(1.5, 1.5, 1);
      break;
    }  //  10
    case 10: {
      PMTChannelEnergy->Fill(2.5, 1.5, 1);
      break;
    }  //  11
    case 11: {
      PMTChannelEnergy->Fill(3.5, 1.5, 1);
      break;
    }  //  12

      // Fourth Row (Bottom Row)
    case 12: {
      PMTChannelEnergy->Fill(0.5, 0.5, 1);
      break;
    }  //  13
    case 13: {
      PMTChannelEnergy->Fill(1.5, 0.5, 1);
      break;
    }  //  14
    case 14: {
      PMTChannelEnergy->Fill(2.5, 0.5, 1);
      break;
    }  //  15
    case 15: {
      PMTChannelEnergy->Fill(3.5, 0.5, 1);
      break;
    }  //  16
  }
}

void HistoManager::FillRPDHitEnergies(G4double edep, G4double pid,
                                      G4int rpdid) {
  if (pid == 11 || pid == -11) {
...
void HistoManager::SetJobRunNumber(G4int Value) { RunNumber = Value; }

// Set ROOT file name
//--------------------
void HistoManager::SetFileName(G4String userFile) { fileName = userFile; }
